...
export default function MenuIcon (props) {
    ...
    const ToggleMenu = props => setToggle(toggle => !toggle);
    ...
    const Icon = props => {
        if (!props.toggleMenu) {
            ...
            return <svg xmlns="http://www.w3.org/2000/svg" width="8.485" height="12.728" viewBox="0 0 8.485 12.728"><g transform="translate(234.63 383.242) rotate(180)"><g transform="translate(233.722 381.834) rotate(180)"><line y2="6" transform="translate(1.214 4.957) rotate(-45)" fill="none" stroke="#000" strokeLinecap="round" strokeWidth="3"/><line x2="6" transform="translate(1.214 4.957) rotate(-45)" fill="none" stroke="#000" strokeLinecap="round" strokeWidth="3"/></g></g></svg>;
        }
    }
